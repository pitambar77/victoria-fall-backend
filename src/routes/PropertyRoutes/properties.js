...
// router.put("/:id/highlights/:highlightId", upload.single("icon"), updateHighlight);
...
// router.put("/:id/amenities/basic/:amenityId", upload.single("icon"), updateBasicAmenity);
// router.delete("/:id/amenities/basic/:amenityId", deleteBasicAmenity);

// // ADDITIONAL AMENITIES
// router.post("/:id/amenities/additional", upload.single("icon"), addAdditionalAmenity);
// router.put("/:id/amenities/additional/:amenityId", upload.single("icon"), updateAdditionalAmenity);
...
// router.put("/:id/activities/:activityId", upload.single("icon"), updateRelatedActivity);
